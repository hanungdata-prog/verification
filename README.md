# Exotic Roleplay Gateway

A lightweight user-gating and verification service designed to sit in front of Discord roleplay servers and ensure only human users pass through.
